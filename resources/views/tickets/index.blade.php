                ...
                <div class="p-6 text-gray-900">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <span class="px-2 py-1 text-xs rounded border
                                            {{ $ticket->priority === 'High' ? 'border-red-500 text-red-600' : 'border-gray-300 text-gray-600' }}">
                                            {{ $ticket->priority }}
                                        </span>
                                    </td>
                                    @if(Auth::user()->role->name === 'admin')
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">No tickets found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
